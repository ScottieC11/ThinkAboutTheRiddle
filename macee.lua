    ...
    MainSection:NewDropdown("GiveGun", "Gives Your Player Selected Gun", {"M9", "Remington 870", "AK-47"}, function(v)
    ...
    local OptionsSection = Options:NewSection("Options")
    OptionsSection:NewKeybind("Close Menu/Reopen Menu", "Hit L to Open and Reopen the Menu", Enum.KeyCode.L, function()
        Library:ToggleUI()
    end)

    local Presets = Window:NewTab("Preset Scripts")
    local PresetsSection = Presets:NewSection("Preset Scripts")
    PresetsSection:NewButton("Get PartFly", "Gets Part Fly Tools", function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/GhostPlayer352/Test4/main/Part%20Fly%20Bypass'))()
    end)
    PresetsSection:NewButton("MM2 Script", "Load MM2 Script", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Ethanoj1/EclipseMM2/master/Script", true))()
    end)
    PresetsSection:NewButton("Evade Script", "Load Evade Script", function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/zReal-King/Evade/main/Main.lua'))()
-- key eqRYZmvsefMPfHeEth2UIn5xumasm33UPbqQ2V7D99GgzRGtzVxI3yPbsVhYa74C
    end)
    PresetsSection:NewButton("Doors Script", "Load Doors Script", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/OminousVibes-Exploit/Scripts/main/doors/main.lua"))()
    end)
    PresetsSection:NewButton("Flee The Facility Script", "Load Flee The Facilty Script", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/khoaScript/scripts/master/flee-the-facility.lua"))()
    end)
    PresetsSection:NewButton("Universal Hitbox Extender", "Extend Hitbox Script", function()
...
-- now, where are my schizo meds?
    ...
    PresetsSection:NewButton("Server Stats", "Server Stats Shower", function()
        loadstring(game:HttpGet("https://pastebin.com/raw/qSQKxrkt", true))()
    end)
    PresetsSection:NewButton("Ultimate Trolling GUI", "Load Troll GUI Script", function()
